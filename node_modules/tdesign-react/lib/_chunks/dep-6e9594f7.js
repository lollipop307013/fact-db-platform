...
import { o as observe } from './dep-40dbfade.js';
  ...
  useMutationObservable(radioGroupRef.current, function (mutations) {
    var hasRelevantChange = mutations.some(function (mutation) {
      ...
      if (mutation.type === "attributes" && mutation.attributeName === "class") {
        ...
        return (_target$classList = target.classList) === null || _target$classList === void 0 ? void 0 : _target$classList.contains("".concat(classPrefix, "-radio-button"));
      }
      return false;
    });
...
//# sourceMappingURL=dep-6e9594f7.js.map
