...
var merge = require('../../_chunks/dep-389164c8.js');
  ...
  function setFieldsValue() {
    ...
    var _setValueByPath = function setValueByPath(value) {
      ...
      if (formItemRef !== null && formItemRef !== void 0 && formItemRef.current) {
        ...
        (_formItemRef$current$2 = (_formItemRef$current2 = formItemRef.current).setValue) === null || _formItemRef$current$2 === void 0 || _formItemRef$current$2.call(_formItemRef$current2, value);
        return;
      }
