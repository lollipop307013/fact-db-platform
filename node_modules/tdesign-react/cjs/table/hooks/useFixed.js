...
var getScrollbarWidth = require('../../_chunks/dep-04384610.js');
var helper = require('../../_chunks/dep-5e6ca3a7.js');
...
var xorWith = require('../../_chunks/dep-90fe1996.js');
...
function useFixed(props, finalColumns, affixRef) {
  ...
  var updateTableWidth = function updateTableWidth() {
    ...
    if (!rect) return;
    var reduceWidth = isWidthOverflow ? scrollbarWidth : 0;
